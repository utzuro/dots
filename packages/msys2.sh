...
UCRT64)
	MINGW_ROOT="/ucrt64"
	MINGW_PKGPFX="mingw-w64-ucrt-x86_64"
	;;
MINGW64)
	MINGW_ROOT="/mingw64"
	MINGW_PKGPFX="mingw-w64-x86_64"
	;;
CLANG64)
	MINGW_ROOT="/clang64"
	MINGW_PKGPFX="mingw-w64-clang-x86_64"
	;;
MSYS | *)
	MINGW_ROOT="/ucrt64"
	MINGW_PKGPFX="mingw-w64-ucrt-x86_64"
	warn "In MSYS shell; defaulting native toolchain to UCRT64."
	;;
esac
