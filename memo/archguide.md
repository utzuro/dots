...
This guide strives to help me remember everything that is needed to install Archlinux
from the scratch, on laptop, with UEFI and encrypted disk and hibernation.
...
### Update pacman repositories to avoid wrong sign issues

```sh
pacman -Sy --noconfirm archlinux-keyring
pacman-key --init
pacman-key --populate archlinux
rm -f /mnt/var/cache/pacman/pkg/*.zst
```
